...
const AnalyticCard: React.FC<{
    ...
    <div className="bg-neutral-800/50 border border-neutral-700 text-white rounded-lg p-4 hover:bg-neutral-700/50 transition-all">
        ...
        <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900">
            <div className="space-y-6 p-6">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    {/* Timeline Content */}
                    <div className="order-2 lg:order-1 flex-1 h-full text-white">
                        <div className="space-y-6">
                            {/* Heatmap and Timeline sections */}
                            <div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4 sm:p-6">
                                <div className="flex flex-col lg:flex-row gap-6">
                                    <div>
                                        <h2 className="text-lg font-semibold mb-4 text-white">Content Activity</h2>
